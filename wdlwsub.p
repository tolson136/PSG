...
UPDATE BDATE LABEL "ENTER VALID SATURDAY DATE"
...
FOR EACH TICKET WHERE TICKET.COMP# = XCOM AND
                      ...
                      (ticket.ticketDATE >= BDATE AND ticket.ticketDATE <= BDATE + 6) AND
                      TICKET.SUB# = XSUB AND
                      TICKET.ROUTE# = XROUTE
                                    BY TICKET.CUST#
                                    BY TICKET.PROPSL#
    ...
    FORM HEADER TODAY FORMAT "99/99/9999"
         "WEEKLY OUTSTANDING D/L TICKET SUB & ROUTE REPORT" AT 13 SKIP(1)
