...
DEFINE VAR TOT1 AS DECIMAL FORMAT "$->>>,>>>,>>>.99".
DEFINE VAR TOT2 AS DECIMAL FORMAT "$->>>,>>>,>>>.99".
DEFINE VAR TOT3 AS DECIMAL FORMAT "$->>>,>>>,>>>.99".
DEFINE VAR TOT4 AS DECIMAL FORMAT "$->>>,>>>,>>>.99".
...
END.
DISPLAY SPACE(4)
"W E E K L Y   O U T S T A N D I N G   D/L   T I C K E T   R E P O R T"
