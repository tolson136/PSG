...
END.
DISPLAY SPACE(5)
"W E E K L Y   C O M P L E T E D   T I C K E T   R E P O R T   S C R E E N"
...
FOR EACH TICKET WHERE TICKET.COMP# = XCOM AND
    ...
    FORM HEADER TODAY FORMAT "99/99/9999"
         "WEEKLY COMPLETED TICKET REPORT" AT 25 SKIP(1)
...
DISPLAY SKIP(0) ACCT-RCV.C-NAME SKIP space(3) FREQ SPACE
              STRING(TICKET.COMP#, ">>") + "-" +
              ...
              TRIM(STRING(T-INDX, ">>"))
                FORMAT "X(25)" SPACE TICKET.DATE-RET SPACE(1)
                TICKET.TOT-AMT-REM FORMAT "$->>>,>>>.99".
END.
