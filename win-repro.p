...
DEF VAR FINV AS DECIMAL FORMAT "ZZZZZZZZZZ"
  LABEL "ENTER BEGINNING INVOICE NUMBER TO REPRINT".
DEF VAR LINV AS DECIMAL FORMAT "ZZZZZZZZZZ"
  LABEL "ENTER ENDING INVOICE NUMBER TO REPRINT".
...
S-TOT = 0.0.
T-TOT = 0.0.
UPDATE SKIP(2) SPACE(10) FINV SKIP SPACE(10) LINV
...
END.
      ...
      FIND FIRST TRANFILE WHERE TRANFILE.COMP# = INVOICE.COMP# AND
                                ...
                                TRANFILE.INV-NO = INVOICE.INV-NO AND
                                TRANFILE.T-TYPE = "N" NO-ERROR.
      IF AVAILABLE TRANFILE THEN DO:
        F-TOT = TRANFILE.T-AMT.
      END.
      ELSE DO:
        F-TOT = 0.00.
      END.
          IF CTR = 1 THEN DO:
            ...
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XA NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 2 THEN DO:
            DISPLAY SKIP(14) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XB NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 3 THEN DO:
            DISPLAY SKIP(13) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XC NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 4 THEN DO:
            DISPLAY SKIP(12) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XD NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 5 THEN DO:
            DISPLAY SKIP(11) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XE NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 6 THEN DO:
            DISPLAY SKIP(10) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XF NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 7 THEN DO:
            DISPLAY SKIP(9) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XG NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 8 THEN DO:
            DISPLAY SKIP(8) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XH NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 9 THEN DO:
            DISPLAY SKIP(7) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XI NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 10 THEN DO:
            DISPLAY SKIP(6) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XJ NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 11 THEN DO:
            DISPLAY SKIP(5) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XK NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 12 THEN DO:
            DISPLAY SKIP(4) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XL NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 13 THEN DO:
            DISPLAY SKIP(3) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XM NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 14 THEN DO:
            DISPLAY SKIP(2) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XN NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 15 THEN DO:
            DISPLAY SKIP(1) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XO NO-BOX NO-LABELS.
          END.
          ELSE
          IF CTR = 16 THEN DO:
            DISPLAY SKIP(0) SPACE(53) "Fuel Surcharge" SPACE(2) F-TOT
            SKIP(1) SPACE(10) INVOICE.TERM-DSC SPACE(45)
            T-TOT + F-TOT SKIP(4) WITH FRAME XP NO-BOX NO-LABELS.
          END.
      END.
  END.
